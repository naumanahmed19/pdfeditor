...
// The snap math now lives in lib/snap.ts (shared with the general annotation
// layer); re-exported here so form-builder call sites keep working unchanged.
export { snapMovingRect, snapResizingRect } from "./snap";
export type { SnapMove, SnapOptions } from "./snap";
