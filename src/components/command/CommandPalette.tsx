...
const EDITOR_TOOLS: Array<{
  ...
  },
  {
    ...
    description: "Click two points (or drag) to measure a distance.",
    icon: Ruler,
    aliases: ["measure", "ruler", "length", "calibrate"],
  },
  {
    key: "measureperim",
    label: "Measure perimeter",
    description: "Click points along a path to measure its length.",
    icon: Route,
    aliases: ["measure", "perimeter"],
  },
  {
    key: "measurearea",
    label: "Measure area",
    description: "Click corners of a region to measure its area.",
    icon: LandPlot,
    aliases: ["measure", "area", "surface"],
  },
  {
    key: "whiteout",
    label: "Whiteout",
